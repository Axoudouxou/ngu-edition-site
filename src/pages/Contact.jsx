...
export default function Contact() {
  ...
  return (
    <div className="bg-background">
      ...
      >
        <h1 className="font-serif text-5xl md:text-6xl font-semibold text-primary mb-4">Contact</h1>
        <p className="font-serif text-lg md:text-xl italic text-foreground/60">Une question, un témoignage, une commande ? On vous lit avec joie.</p>
      </motion.div>
      ...
      <div className="max-w-6xl mx-auto px-6 pb-20">
        <div className="grid md:grid-cols-[1fr_320px] gap-12 md:gap-16">
          ...
          >
            <div className="bg-white rounded-2xl p-8 shadow-md border border-border/40">
              <TallyEmbed />
            </div>
          </motion.div>
          ...
          >
            ...
            {/* Réseaux sociaux */}
            <div>
              <h2 className="font-serif text-2xl font-semibold text-primary mb-6">Suivez-nous</h2>
              <div className="flex gap-3">
                {socials.map(social => (
                  <a
                    ...
                    className="w-12 h-12 rounded-full bg-primary flex items-center justify-center text-primary-foreground hover:opacity-80 transition-opacity"
