...
export default function MentionsLegales() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-16 md:py-24">
      <h1 className="font-serif text-4xl font-semibold text-primary mb-10">Mentions légales</h1>
      <div className="prose prose-neutral max-w-none space-y-6 text-foreground/70 leading-relaxed">
